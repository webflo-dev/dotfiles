...
local function worker()
	...
	awesome.connect_signal("signal::battery::update", function(percentage, state)
		...
		elseif state == UPower_States.Fully_charged and percentage > 90 and battery_state ~= Battery_States.Full then
			icon_widget:set_text("")
			widget:set_bg(beautiful.yellow)
